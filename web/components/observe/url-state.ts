...
/**
 * OBSERVE 页 URL 状态（?mode=&days=）：history.replaceState 同步 + useSyncExternalStore 订阅。
...
export type ObserveUrlState = { mode: ObserveMode; days: number };

const DEFAULTS: ObserveUrlState = { mode: "signal", days: 7 };
